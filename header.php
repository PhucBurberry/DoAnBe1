        ...
        <div id="top-header">
            <div class="container">
                <ul class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> +84 999088099</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i> phonestore@email.com</a></li>
                    <li><a href="#"><i class="fa fa-map-marker"></i> 53 Vo Van Ngan</a></li>
                </ul>
